...
#' przy zalozeniu ze slowa lub wyrazenia z jednego tekstu sa odseparowane '@'
#' 
#' @usage frakcja(a1, a2)
#' @param a1 tekst pierwszy, typu character (wyrazenia rozdzielone '@')
#' @param a2 tekst drugi, typu character (wyrazenia rozdzielone '@')
#'
#' @return
...
#' @example
#' 
#' frakcja("abba@cos@kot","ala@ma@kota")
#'
